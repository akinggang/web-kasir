...
<strong>Fitur website</strong>
  ...
  <ol type="a">
   ...
   <strong>Langkah-langkah untuk menggunakan website ini</strong>
    ...
    <li>import file database "kasir_aking.sql"</li>
  ...
  -> Catatan(PENTING) :
    <i>Sebelum mengimport database, pastikan anda membuat database sesuai dengan nama database yang ada di dalam folder db, yaitu 'kasir_aking.sql'</i>
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
